...
export default function Home() {
  return (
    <div className="  h-[94%] overflow-auto">
      ...
      <Card shadow="sm" className="w-[800px] bg-[#222222] text-main h-[400px]"  isPressable onPress={() => console.log("item pressed")}>
        ...
        <Card shadow="sm" className="w-[650px] bg-[#222222] text-main h-[400px]"  isPressable onPress={() => console.log("item pressed")}>
          <CardBody className="overflow-visible p-0">
            <Image
              shadow="sm"
              radius="lg"
